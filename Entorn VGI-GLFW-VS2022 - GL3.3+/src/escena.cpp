...
//
//	  Versi� 2.6:	- Inclusi� de texte en BITMAP o caracters gr�fics (STROKE)
//
...
//   SeleccionaMaterial(MAT_DEFAULT);	
	...
	{	delay = 1.0*h*it1;
		...
		{	//glBegin(GL_POLYGON);
			  ...
			  vertices.push_back(0.0+i+step);		vertices.push_back(j);			vertices.push_back(0.0);		// Vector Vertices
			  ...
			  vertices.push_back(0.0+i+step);	vertices.push_back(0.0+j+step);		vertices.push_back(0.0);		// Vector Vertices
...
// ----------------------- VAO
			...
			//glBegin(GL_POLYGON);
			  ...
			  vertices.push_back(i);			vertices.push_back(0.0+j+step);	vertices.push_back(0.0);	// Vector Vertices
