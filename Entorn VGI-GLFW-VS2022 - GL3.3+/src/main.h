...
//******** Entorn b�sic VS2019 MONOFINESTRA amb OpenGL, interf�cie GLFW i llibreries GLM
...
// ---------------- Entorn VGI: Tractament d'errors
	...
	//char * CString2Char(CString entrada);		// Conversi� string CString --> char *
//	void Refl_MaterialOff();					// Desactivar Reflexi� de Material
//	void Refl_MaterialOn();						// Activar Reflexi� de Material
