...
Maleta::Maleta(Transform transform, Model* model, GLuint shader_program_id, GameEntity* tapa) : InteractableEntity(transform, model, shader_program_id, InteractionType::SIT), my_aixecada(false)
{
	my_tapa = tapa;
	addChild(tapa);
